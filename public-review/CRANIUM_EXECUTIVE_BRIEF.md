...
Synapse may restrict or escalate. Only the Kernel may grant authority. The transition is canonical, replay-protected, and receipt-bound.
...
Additional repositories provide hardened variants, cognitive substrate implementations, operator surfaces, and dedicated acquisition delivery vehicles (boot drives, diligence workbench, portfolio).

**Design principle:** Each product stands alone. Shared contracts enable composition. Forced bundling is avoided.
...
**Present:** Authority-boundary vertical slice, receipt chaining, signed attestations, multi-language CI, security scanning, offline bootable demonstration drives, explicit capability honesty.

**Still required:** Full production key lifecycle, complete Authorization and Immunity contracts, independent security and prior-art review, shared conformance corpus.

Evidence posture is deliberately conservative. Green CI is not presented as proof of security or production readiness.
