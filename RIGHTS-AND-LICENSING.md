...
Unless a repository-specific license or written agreement states otherwise, the source code, documentation, media, generated artifacts, marks, and other materials in this repository are proprietary and are not granted an implied right to copy, modify, distribute, sublicense, or commercially exploit them.

Third-party dependencies remain subject to their own licenses. Generated artifacts, fonts, models, media, provider services, and trademarks may have additional terms and must be inventoried separately during diligence.

This notice is an ownership and licensing record, not legal advice. The final rights chain, assignments, trademarks, and transfer or licensing terms should be confirmed by qualified counsel.
